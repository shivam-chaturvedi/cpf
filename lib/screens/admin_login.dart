...
class _AdminLoginPageState extends State<AdminLoginPage> {
  ...
  Future<void> _handleAdminLogin() async {
    ...
    if (email == adminEmail && password == adminPassword) {
      ...
      if (mounted) {
        AppHelpers.showErrorSnackBar(context, 'Invalid admin credentials. Please check email and password.');
      }
    }
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: CustomButton(
                                text: 'NGO Login',
                                onPressed: () => Navigator.pushReplacementNamed(context, '/ngo-login'),
                                icon: Icons.login,
                                isOutlined: true,
                              ),
                            ),
                            ...
                            Expanded(
                              child: CustomButton(
                                text: 'NGO Register',
                                onPressed: () => Navigator.pushReplacementNamed(context, '/ngo-register'),
