  ...
  class NGODashboardWrapper extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
      ...
      return StreamBuilder<DocumentSnapshot>(
        ...
        // Allow access to dashboard even if profile is not complete
        // Show verification status and profile completion options
        return NGODashboard();
        },
      );
    }
...
class _NGODashboardState extends State<NGODashboard>
  ...
  Future<void> _downloadRegistrationDocument(
      String ngoId, String filename, String originalName) async {
      try {
        showDialog(
          context: context,
          barrierDismissible: false,
  ...
  Future<void> _downloadProposalDocument(
            ...
            builder: (context) => AlertDialog(
              ...
              content: Column(
                ...
                const Icon(Icons.info_outline,
                    size: 48, color: AppTheme.warningOrange),
    ...
    Future<void> _sendProposalToCPF(Map<String, dynamic> proposalData) async {
      ...
      final subject =
          Uri.encodeComponent('Proposal Submission: ${proposalData['title']}');
  ...
  ${ngoData['chiefFunctionaryName'] ?? ngoData['ngoName']}
      ...
      final mailtoUrl =
          'mailto:support@cpfindia.org?subject=$subject&body=$body';
      ...
      AppHelpers.showSuccessSnackBar(
          context, 'Email prepared. Please send it from your email client.');
      } catch (e) {
        // Close loading dialog if still open
        if (Navigator.canPop(context)) {
          Navigator.pop(context);
  ...
  try {
    ...
    showDialog(
      ...
      await _firestore
        ...
        'status': 'submitted',
          'storageType': 'supabase', // Flag to indicate this uses Supabase storage
      });
    ...
    children: docs.map((doc) {
      ...
      final financialYear = data['financialYear'];
          final storageType = data['storageType'] ??
              'firestore'; // Default to firestore for old data
...
Future<void> _submitProposal() async {
  ...
  try {
    ...
    Map<String, dynamic>? proposalResult;
      ...
      if (_proposalDocumentMetadata == null) {
        ...
        AppHelpers.showErrorSnackBar(context, 'Please upload a proposal document');
        return;
    }
                      ...
                      onPressed: () {
                        ...
                        if (uid != null) {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                            builder: (context) =>
                                NGOCompleteProfilePage(uid: uid),
                            ),
                          );
                        }
                      },
              ...
              CustomCard(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                  _buildRegistrationDocumentsList(
                      ngoData['documents'] as Map<String, dynamic>),
                  ],
                ),
              ),
              const SizedBox(height: 16),
              ...
              builder: (context, snapshot) {
                ...
                return Column(
                  children: snapshot.data!.docs.map((doc) {
                    ...
                    _formatDateTime(
                        activity['timestamp']?.toDate() ?? DateTime.now()),
    ...
    Widget _buildDefaultActivityItems(Map<String, dynamic> ngoData) {
      ...
      if (ngoData['reviewedAt'] != null) {
        ...
        status == 'approved'
            ? 'Your NGO has been validated and approved'
        ...
        child: Column(
          ...
          children: [
            ...
            _buildProfileItem('Location',
                '${ngoData['district'] ?? ''}, ${ngoData['state'] ?? ''}, ${ngoData['country'] ?? ''}'),
            ...
            _buildProfileItem(
                'Correspondence Address', ngoData['correspondingAddress']),
            ]),
            ...
            _buildProfileItem(
                'Gross Amount Raised',
                ngoData['grossAmountRaised'] != null
                    ? '₹${ngoData['grossAmountRaised']}'
                    : null),
            ...
            _buildProfileItem('Professional Tax Registration',
                ngoData['professionalTaxRegistration']),
              _buildProfileItem('12A Certificate', ngoData['cert12A']),
              _buildProfileItem('80G Certificate', ngoData['cert80G']),
            _buildProfileItem('Registration Certificate Number',
                ngoData['registrationCertNumber']),
            ]),
          ...
          if (ngoData['socialMediaUrls'] != null &&
              (ngoData['socialMediaUrls'] as Map).isNotEmpty) ...[
          ...
          child: Column(
            ...
            children: [
              ...
              ...documents.entries.map((entry) {
                ...
                final docData = entry.value as Map<String, dynamic>;
              final label =
                  documentLabels[docType] ?? docType.replaceAll('_', ' ');
                                ...
                                children: [
                                  ...
                                  if (documents.isNotEmpty) ...[
                                    ...
                                    ...documents.entries.map((docEntry) {
                                      final docType = docEntry.key;
                                    final docData =
                                        docEntry.value as Map<String, dynamic>;
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Expanded(
                                        ...
                                        onPressed: sentToCPF
                                            ? null
                                            : () => _sendProposalToCPF(data),
                                        icon: sentToCPF
                                            ? Icons.check_circle
                                            : Icons.email,
                                        backgroundColor: sentToCPF
                                            ? AppTheme.textSecondary
                                            : AppTheme.primaryOrange,
                                        ),
                                      ),
  ...
  Widget _buildDownloadItem(IconData icon, String title, String description,
      VoidCallback onDownload, bool isAvailable) {
        return Container(
          margin: const EdgeInsets.only(bottom: 12),
          padding: const EdgeInsets.all(16),
          decoration: BoxDecoration(
  ...
  Widget _buildVerificationStatusBanner(Map<String, dynamic> ngoData) {
    ...
    if (verificationStatus == 'verified') {
      bannerColor = AppTheme.accentGold;
      bannerIcon = Icons.verified;
      bannerTitle = 'Account Verified';
      bannerMessage =
          'Your NGO account has been verified by admin. You can now submit proposals.';
    } else if (verificationStatus == 'rejected') {
      bannerColor = AppTheme.errorRed;
      bannerIcon = Icons.cancel;
      bannerTitle = 'Verification Required';
      bannerMessage =
          'Admin has requested changes. Please contact support for details.';
    } else {
      bannerColor = AppTheme.warningOrange;
      bannerIcon = Icons.pending;
      bannerTitle = 'Pending Verification';
      bannerMessage =
          'Your account is under review. Admin will contact you soon. Complete your profile while waiting.';
    }
                  ...
                  ElevatedButton.icon(
                    onPressed: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              NGOCompleteProfilePage(uid: ngoData['uid']),
                        ),
                      );
                    },
